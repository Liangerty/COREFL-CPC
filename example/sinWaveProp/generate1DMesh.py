...
nx = None  # Number of grid points in x direction, nx and dx will be used to calculate each other, only one of them needs to be set, the other one can be set to None
dx = 1e-1  # Grid size in x direction in [meters] (0.0002)
