...
namespace cfd {
template<MixtureModel mixture_model> void implicit_treatment(const Block &block, const DParameter *param, DZone *d_ptr,
  const Parameter &parameter, DZone *h_ptr, DBoundCond &bound_cond, real diag_factor = 0) {
