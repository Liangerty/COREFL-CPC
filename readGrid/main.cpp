...
int main() {
  std::cout << "Read grid starts. This program reads Plot3D outputted by Pointwise, not Gridgen!\n";
        ...
        for (int i = 0; i < n_outer[target_block]; ++i) {
          ...
          if (interior_target_id[target_block][f_tar] == b) {
            if (range_interior[target_block][f_tar][0] == range_interior_target[b][f][0] &&
              ...
              target_face = i;
              break;
            } else if (range_interior[target_block][f_tar][0] == range_interior_target[b][f][1] &&
              ...
              target_face = i;
              break;
            } else if (range_interior[target_block][f_tar][0] == range_interior_target[b][f][0] &&
                       range_interior[target_block][f_tar][1] == range_interior_target[b][f][1] &&
