...
public:
  ...
  void output_data(const Parameter &parameter, const std::vector<Field> &field, real t, int step) const;
...
public:
  ...
  void output_block_monitors(const Parameter &parameter, const std::vector<Field> &field, real t, int step) const;
